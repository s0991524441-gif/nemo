...
| `#/discovery` | موجود كمرجع واجهة | طلب اكتشاف | App Shell |
| `#/discovery-jobs` | Placeholder | عمليات البحث | App Shell |
| `#/job` | موجود كمرجع واجهة | تفاصيل Job | App Shell |
| `#/results` | موجود كمرجع واجهة | النتائج | App Shell |
