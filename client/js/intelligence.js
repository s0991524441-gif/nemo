...
function analysisAction(record) {
  ...
  return `<button type="button" class="button compact" data-route="intelligence?business=${id}" data-business="${id}">فتح الذكاء</button>`;
}
